...
import com.brilliant.launcher.Config;
...
import com.brilliant.launcher.other.Lists;
...
public class SplashActivity extends AppCompatActivity{
    ...
    private void DoIt() {
        ...
        Lists.serverList.add(new Servers(true, "Culilan", 0, 500));
        Lists.serverList.add(new Servers(false, "Vistaria", 0, 1000));
